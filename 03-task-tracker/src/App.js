...
function App() {
  ...
  const [{isOver}, drop] = useDrop(()=>({
    accept:"todo",
    drop: (item) => addToCompleted(item.id, item.projectName, 
  ...
  return (
   <> 
      ...
      <div className="w-full">
        <h2 className="ml-6 text-xl font-semibold w-3/4 max-w-lg my-4 py-2 px-4 bg-gray-400
        ">To Do:</h2>
    ...
    <h2 className="text-xl font-semibold w-3/4 max-w-lg my-4 py-2 px-4 bg-gray-400
        ">Completed:</h2>
